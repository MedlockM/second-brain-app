    ...
    <div className="min-h-screen py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <span
            className={`text-${primaryColor || 'sky-500'} font-semibold text-sm uppercase tracking-wider`}
          >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      ${
                        isActive
                          ? `bg-${primaryColor || 'sky-500'} text-white`
                          : `bg-${primaryColor || 'sky-500'}/10 dark:bg-black/80 text-${primaryColor || 'sky-500'}`
                      }
                    `}
                    >
                      <Icon size={24} />
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 bg-white dark:bg-black/80 rounded-sm   h-1 overflow-hidden">
                        {isActive && (
                          <motion.div
                            className={`h-full ${progressGradientLight || 'bg-gradient-to-r from-sky-400 to-sky-500'} dark:${progressGradientDark || 'bg-gradient-to-r from-sky-300 to-sky-400'}`}
                            initial={{ width: 0 }}
