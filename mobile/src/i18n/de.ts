...
export const de: Catalog = {
  ...
  "mediaError.imagePostUnsupported": "Dieser Beitrag ist ein Foto – es gibt nichts zu transkribieren.",
  ...
  "plan.highlight.organise":
    "Sortiere in Ordner und Tags, durchsuche alles, täglicher Digest",
  ...
  "plan.includes.organise.file":
    "Lege alles in Ordnern und Tags ab, beim Speichern oder jederzeit danach.",
