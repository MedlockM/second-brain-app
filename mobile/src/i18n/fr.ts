...
export const fr: Catalog = {
  ...
  "mediaError.imagePostUnsupported": "Cette publication est une photo : il n'y a rien à transcrire.",
  ...
  "plan.card.allowance": "{duration} de transcription",
  ...
  "plan.minutesRule":
    "Les minutes couvrent l'audio et la vidéo que nous transcrivons. Les articles et les pages web ne coûtent aucune minute, et lire votre bibliothèque est illimité.",
  ...
  "home.unsortedReview": "Tri des non classés",
  "home.unsortedReviewA11y": "Trier vos médias non classés, {count}",
  ...
  "unsortedReview.title": "Tri des non classés",
  "unsortedReview.position": "{current} / {total}",
  "unsortedReview.positionA11y": "Source {current} sur {total}",
  "unsortedReview.closeA11y": "Fermer le tri des non classés",
