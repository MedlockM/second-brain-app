...
as the sort key. The Python API uses "media_key" as the media-agnostic name.

Table schema:
- Env var: USER_MEDIA_SUBMISSIONS_TABLE (default "user_episode_submissions")
- PK: user_id (S)
- SK: episode_guid (S) [legacy column name, maps to media_key]
...
USER_MEDIA_SUBMISSIONS_TABLE = os.environ.get(
    "USER_MEDIA_SUBMISSIONS_TABLE",
    os.environ.get("USER_EPISODE_SUBMISSIONS_TABLE", "user_episode_submissions"),
)

# Legacy DynamoDB column name for the sort key
_SK_COLUMN = "episode_guid"
